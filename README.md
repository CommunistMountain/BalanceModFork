...
You may find the documentation for Bugfixes and QOL below. Documentation for Balance Changes (CM) and Balance Changes (Twinge) are in [README_CM.md](https://github.com/CommunistMountain/BalanceModFork/blob/main/README_CM.md) and [README_Twinge.md](https://github.com/CommunistMountain/BalanceModFork/blob/main/README_Twinge.md) respectively.
...
<ol>
    ...
    <li>The game starts paused when loading a game from a save.</li>
