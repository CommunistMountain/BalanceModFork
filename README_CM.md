...
<ol>
    ...
    <ol>
        ...
        <ol>
            ...
            <li>Crystal Vengeance: Effect chance from 10% to 100%, damage from 1 to 0 (note that it still does damage to supershields), breach chance from 10% to 100%, stun chance from 20% to 100%.</li>
    ...
    <ol>
        ...
        <ol>
            ...
            <li>Mantis A: Weapons from 1 Small Bomb and 1 Basic Laser to 1 Small Bomb. Drone Control has 3 drone slots when bought. Added level 1 Sensors.</li>
